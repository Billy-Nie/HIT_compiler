...
keywords = [ "auto", "double", "int", "struct", "break", "else", "long", "switch", "case", "enum", "register",
        ...
        "default", "goto", "sizeof", "volatile", "do", "if", "while", "static", "String"]
...
digitDFA_path = a + "/DigitDFA"
charDFA_path = a + "/charDFA"
stringDFA_path = a + "/stringDFA"
commentDFA_path = a + "/commentDFA"
O_H_DFA_path = a + "/O_H_DFA"
...
class O_H_DFA:
    ...
    def __init__(self, O_H_DFA_path):
